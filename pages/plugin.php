<body class="body-center" id="plugin" >
	...
	<div class="pull-left">
		<h1>Plugin</h1>
		<span class="model desc"><i class="fa fa-terminal"></i>  / merlin.php /  <b class="animated animated2 infinite fadeIn">Plugin.php</b></span>
	</div>
